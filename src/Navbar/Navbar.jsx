...
const Navbar = () => {
  return (
    <nav className='bg-secondry_color'>
        <div className="container">
            <div className="nav_main">
                <div className="nav_top flex justify-between items-center">
                    ...
                    <input type="text" placeholder='Search your item' className='focus:outline-none border-[2px] border-primary_color rounded-full w-full py-[10px] pl-[20px] pr-[40px] h-[50px] bg-transparent'  />
